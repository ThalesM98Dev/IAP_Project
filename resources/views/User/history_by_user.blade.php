      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{route('history.choosing_file')}}">
                        <i class="material-icons">content_paste</i>
                        <p>File History</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="{{route('history.export_user_history')}}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div id="page-wrapper">
                        <h1 class="text-center font-weight-bold text-purple">History</h1>
                        <div id="page-inner">
                            <div class="row">
                                <style>
                                    .text-purple {
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <th class="text-purple">Editor</th>
                                        <th class="text-purple">File Name</th>
                                        <th class="text-purple">Time Stamp</th>
                                    </tr>
                                    @if (!empty($history))
                                        @foreach($history as $item)
                                            <tr>
                                                <td class="text-white">{{$item->action}}</td>
                                                <td class="text-white">{{\App\Models\User::find($item->editor_id)->name}}</td>
                                                <td class="text-white">{{\App\Models\File::withTrashed()->find($item->file_id)->name}}</td>
